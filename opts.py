...
def parse_opts():
    ...
    parser.add_argument('--model_name', default='cnn', type=str, help='Currently only support 3D-CNN')

    # parser.add_argument('--cnn', action='store_true', default=False,
    #                     help='whether to train the 3d-cnn model')
    ...
    # parser.add_argument('--frame_size', default='228', type=int, help='Resize each frame to this dimension')
